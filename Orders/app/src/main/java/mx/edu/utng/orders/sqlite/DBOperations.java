...
public final class DBOperations {
    ...
    public Cursor getCategoryById(String idCategory){
        SQLiteDatabase database = db.getReadableDatabase();
        String sql = String.format("SELECT * FROM %s" +
                        " WHERE %s=?",
                OrderDB.Tables.CATEGORY,
    ...
    public String insertCategory(Category category){
        SQLiteDatabase database = db.getWritableDatabase();
        String idCategory = OrderContract.Categories.generateIdCategory();
        ContentValues values = new ContentValues();
        values.put(OrderContract.Categories.ID, idCategory);
        values.put(OrderContract.Categories.CATEGORY_NAME, category.getCategoryName());
        values.put(OrderContract.Categories.LIST_POSITION, category.getListPosition());
    ...
    public boolean updateCategory(Category category){
        ...
        values.put(OrderContract.Categories.CATEGORY_NAME, category.getCategoryName());
        values.put(OrderContract.Categories.LIST_POSITION, category.getListPosition());
        String whereClause = String.format("%s=?", OrderContract.Categories.ID);

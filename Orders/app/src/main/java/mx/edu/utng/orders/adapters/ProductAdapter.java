...
/**
 * Created by Santana on 2/15/2017.
 */
...
//getter and setter de listener
    ...
    public static class ProductViewHolder extends  RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ProductViewHolder(View itemView) {
            super(itemView);
            cvProduct=(CardView)itemView.findViewById(R.id.cv_category);
            iv_Product=(ImageView)itemView.findViewById(R.id.iv_category);
            tvProductName=(TextView)itemView.findViewById(R.id.tv_category_name);
            tvProductPrice=(TextView)itemView.findViewById(R.id.tv_list_position);
            ...
            btDeleteProduct=(ImageButton) itemView.findViewById(R.id.bt_delete_category);
